...
import TrainingPathway from './training/TrainingPathway';
import TrainingLevel from './training/TrainingLevel';
import TrainingCertifications from './training/TrainingCertifications';
import TrainingSpecialization from './training/TrainingSpecialization';
import '../training.css';

const TrainingOverview = () => {
  return (
    <div id="courses" className="training-body overflow-hidden pt-16 pb-0 relative">
      <div className="blob-container">
        <div className="blob" style={{ background: 'var(--teal)', width: '600px', height: '600px', top: '10%', left: '-10%' }}></div>
        <div className="blob" style={{ background: 'var(--cobalt)', width: '500px', height: '500px', top: '40%', right: '-5%' }}></div>
        <div className="blob" style={{ background: 'var(--gold)', width: '700px', height: '700px', bottom: '10%', left: '20%' }}></div>
      </div>
      ...
      <div className="container mx-auto relative z-10">
        <motion.div 
          ...
          className="px-4 text-center mb-24"
        >
          <h2 className="text-4xl md:text-7xl font-display font-bold mb-6 tracking-tight">
            Our AI <span className="text-gradient-gold">Training Pathway</span>
          </h2>
          <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-relaxed">
            A comprehensive four-stage learning journey designed to take you from 
            <span className="text-foreground font-semibold"> first principles </span> 
            to <span className="text-gradient-gold font-semibold"> professional-grade AI development.</span>
          </p>
        </motion.div>
      </div>
